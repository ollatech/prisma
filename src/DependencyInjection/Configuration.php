        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('entrypoint')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('api')->defaultValue('Olla\Prisma\Controller\ApiController')->end()
                        ->scalarNode('admin')->defaultValue('Olla\Prisma\Controller\AdminController')->end()
                        ->scalarNode('frontend')->defaultValue('Olla\Prisma\Controller\FrontendController')->end()
                        ->scalarNode('graphql')->defaultValue('Olla\Prisma\Placeholder\Controller')->end()
                    ->end()
                ->end()
                ->arrayNode('operation')
                    ->addDefaultsIfNotSet()
