        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('entrypoint')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('api')->defaultValue('Olla\Prisma\Placeholder\Controller')->end()
                        ->scalarNode('admin')->defaultValue('Olla\Prisma\Placeholder\Controller')->end()
                        ->scalarNode('frontend')->defaultValue('Olla\Prisma\Placeholder\Controller')->end()
